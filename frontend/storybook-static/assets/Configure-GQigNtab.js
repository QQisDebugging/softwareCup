...
interactive reference documentation from your components and stories.`}),e.jsxs("a",{className:"sb-action-link",href:"https://storybook.js.org/docs/writing-docs/autodocs/?renderer=vue3&ref=configure",target:"_blank",children:["Learn more",e.jsx(s,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:x,alt:"A browser window showing a Storybook being published to a chromatic.com URL"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Publish to Chromatic"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Publish your Storybook to review and collaborate with your entire team."}),e.jsxs("a",{className:"sb-action-link",href:"https://storybook.js.org/docs/sharing/publish-storybook/?renderer=vue3&ref=configure#publish-storybook-with-chromatic",target:"_blank",children:["Learn more",e.jsx(s,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:b,alt:"Windows showing the Storybook plugin in Figma"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Figma Plugin"}),e.jsx("p",{className:"sb-section-item-paragraph",children:`Embed your stories into Figma to cross-reference the design and live
implementation in one place.`}),e.jsxs("a",{className:"sb-action-link",href:"https://storybook.js.org/docs/sharing/design-integrations/?renderer=vue3&ref=configure#embed-storybook-in-figma-with-the-plugin",target:"_blank",children:["Learn more",e.jsx(s,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:C,alt:"Screenshot of tests passing and failing"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Testing"}),e.jsx("p",{className:"sb-section-item-paragraph",children:`Use stories to test a component in all its variations, no matter how
complex.`}),e.jsxs("a",{className:"sb-action-link",href:"https://storybook.js.org/docs/writing-tests/?renderer=vue3&ref=configure",target:"_blank",children:["Learn more",e.jsx(s,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:f,alt:"Screenshot of accessibility tests passing and failing"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Accessibility"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Automatically test your components for a11y issues as you develop."}),e.jsxs("a",{className:"sb-action-link",href:"https://storybook.js.org/docs/writing-tests/accessibility-testing/?renderer=vue3&ref=configure",target:"_blank",children:["Learn more",e.jsx(s,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:u,alt:"Screenshot of Storybook in light and dark mode"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Theming"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Theme Storybook's UI to personalize it to your project."}),e.jsxs("a",{className:"sb-action-link",href:"https://storybook.js.org/docs/configure/theming/?renderer=vue3&ref=configure",target:"_blank",children:["Learn more",e.jsx(s,{})]})]})]})})]}),`
`,e.jsxs("div",{className:"sb-addon",children:[e.jsxs("div",{className:"sb-addon-text",children:[e.jsx("h4",{children:"Addons"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Integrate your tools with Storybook to connect workflows."}),e.jsxs("a",{className:"sb-action-link",href:"https://storybook.js.org/addons/?ref=configure",target:"_blank",children:["Discover all addons",e.jsx(s,{})]})]}),e.jsx("div",{className:"sb-addon-img",children:e.jsx("img",{src:j,alt:"Integrate your tools with Storybook to connect workflows."})})]}),`
`,e.jsxs("div",{className:"sb-section sb-socials",children:[e.jsxs("div",{className:"sb-section-item",children:[e.jsx("img",{src:n,alt:"Github logo",className:"sb-explore-image"}),e.jsx(i.p,{children:"Join our contributors building the future of UI development."}),e.jsxs("a",{className:"sb-action-link",href:"https://github.com/storybookjs/storybook",target:"_blank",children:["Star on GitHub",e.jsx(s,{})]})]}),e.jsxs("div",{className:"sb-section-item",children:[e.jsx("img",{src:c,alt:"Discord logo",className:"sb-explore-image"}),e.jsxs("div",{children:[e.jsx(i.p,{children:"Get support and chat with frontend developers."}),e.jsxs("a",{className:"sb-action-link",href:"https://discord.gg/storybook",target:"_blank",children:["Join Discord server",e.jsx(s,{})]})]})]}),e.jsxs("div",{className:"sb-section-item",children:[e.jsx("img",{src:l,alt:"Youtube logo",className:"sb-explore-image"}),e.jsxs("div",{children:[e.jsx(i.p,{children:"Watch tutorials, feature previews and interviews."}),e.jsxs("a",{className:"sb-action-link",href:"https://www.youtube.com/@chromaticui",target:"_blank",children:["Watch on YouTube",e.jsx(s,{})]})]})]}),e.jsxs("div",{className:"sb-section-item",children:[e.jsx("img",{src:d,alt:"A book",className:"sb-explore-image"}),e.jsx("p",{children:"Follow guided walkthroughs on for key workflows."}),e.jsxs("a",{className:"sb-action-link",href:"https://storybook.js.org/tutorials/?ref=configure",target:"_blank",children:["Discover tutorials",e.jsx(s,{})]})]})]}),`
...
`})]})}function y(t={}){const{wrapper:i}={...r(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(o,{...t})}):o(t)}export{s as RightArrow,y as default};
